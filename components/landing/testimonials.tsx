...
const testimonials = [
  {
    quote: "I was losing 4-5 calls a day just because I couldn't answer while under a sink. TradeSpeak sorted that in 10 minutes. Got 3 new jobs the first week.",
